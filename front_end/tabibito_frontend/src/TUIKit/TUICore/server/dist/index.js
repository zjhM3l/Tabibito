...
var TUIAegis_1 = require("../../utils/TUIAegis");
var TUICore = /** @class */ (function (_super) {
    ...
    function TUICore(params) {
        ...
        if (!params.tim) {
            window.TUIKit = tim_1["default"].create({ SDKAppID: _this.SDKAppID, devMode: true });
        }
        else {
    ...
    TUICore.init = function (options) {
        var Aegis = TUIAegis_1["default"].getInstance();
        if (!TUICore.instance) {
    ...
    TUICore.prototype.login = function (options) {
        ...
        return new Promise(function (resolve, reject) {
            _this.tim
                ...
                if ((_e = (_d = TUICore === null || TUICore === void 0 ? void 0 : TUICore.instance) === null || _d === void 0 ? void 0 : _d.TUIServer) === null || _e === void 0 ? void 0 : _e.TUICallKit) {
                    TUIAegis_1["default"].getInstance().reportEvent({
                        name: 'SDKAppID',
